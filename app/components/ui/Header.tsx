...
export default function Header() {
  ...
  return (
    <header className="fixed inset-block-start-0 inset-inline-0 z-50 border-b border-border-secondary bg-bg-primary/80 backdrop-blur-md">
      <nav aria-label="Main Navigation" className="m-inline-auto flex h-16 max-w-7xl items-center justify-between p-inline-responsive">
        ...
        {/* Desktop Links — using modern :has() spotlight effect */}
        <ul className="nav-spotlight hidden items-center md:flex list-none">
          <li><Link href="#" className="text-sm font-medium text-text-secondary hover:text-text-primary focus-visible:text-accent-primary outline-none">Platform</Link></li>
          <li><Link href="#" className="text-sm font-medium text-text-secondary hover:text-text-primary focus-visible:text-accent-primary outline-none">Solutions</Link></li>
          <li><Link href="#" className="text-sm font-medium text-text-secondary hover:text-text-primary focus-visible:text-accent-primary outline-none">Pricing</Link></li>
          <li><Link href="#" className="text-sm font-medium text-text-secondary hover:text-text-primary focus-visible:text-accent-primary outline-none">Company</Link></li>
        </ul>
        ...
        <div className="hidden items-center gap-4 md:flex">
          ...
          <button className="rounded-full bg-text-primary p-inline-5 p-block-2 text-sm font-semibold text-bg-primary hover:bg-text-secondary transition-all active:scale-95 focus-visible:ring-2 focus-visible:ring-accent-primary outline-none">Get Started</button>
        </div>
      ...
      >
        <div className="flex flex-col gap-4 p-6">
          ...
          <hr className="border-border-secondary m-block-2" />
          ...
          <div className="flex flex-col gap-3">
            ...
            <button className="w-full rounded-full bg-text-primary p-block-3 text-base font-semibold text-bg-primary hover:bg-text-secondary transition-all" onClick={() => setIsMenuOpen(false)}>Get Started</button>
          </div>
        </div>
      </div>
    </header>
