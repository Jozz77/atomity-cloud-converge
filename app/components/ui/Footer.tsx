...
export default function Footer() {
  return (
    <footer className="border-t border-border-secondary bg-bg-secondary/50 p-block-8" aria-label="Main Footer">
      <div className="mx-auto max-w-7xl p-inline-responsive flex flex-col items-center justify-between gap-8 md:flex-row">
